...
var _searchbarView = require("./view/searchbarView");
var _searchbarViewDefault = parcelHelpers.interopDefault(_searchbarView);
var _cityView = require("./view/cityView");
var _cityViewDefault = parcelHelpers.interopDefault(_cityView);
var _metricsView = require("./view/metricsView");
var _metricsViewDefault = parcelHelpers.interopDefault(_metricsView);
var _dailyView = require("./view/dailyView");
var _dailyViewDefault = parcelHelpers.interopDefault(_dailyView);
var _hourlyView = require("./view/hourlyView");
var _hourlyViewDefault = parcelHelpers.interopDefault(_hourlyView);
var _settingView = require("./view/settingView");
var _settingViewDefault = parcelHelpers.interopDefault(_settingView);
var _errorView = require("./view/errorView");
var _errorViewDefault = parcelHelpers.interopDefault(_errorView);
...
const controlUserLocation = async function() {
    try {
        ...
        await _model.loadUserLocation();
        // 2. Get forecast of user location
        await controlCityWeather();
    } catch (error) {
        (0, _errorViewDefault.default).render(error);
    }
};
const controlCitySearch = async function(cityName) {
    try {
        // 1. Render Loading state
        (0, _cityViewDefault.default).renderLoader();
        // 2. load Country coordinates
        await _model.loadCity(cityName);
        // 3. load forecast of inpust city
        await controlCityWeather();
    } catch (error) {
        (0, _cityViewDefault.default).render(_model.state);
        (0, _cityViewDefault.default).setBackground();
        (0, _errorViewDefault.default).render(error);
    }
};
const controlCityWeather = async function() {
    try {
        ...
        await _model.loadForecast(units);
        // 2. Render city current temperature, Name and date
        (0, _cityViewDefault.default).render(_model.state);
        (0, _cityViewDefault.default).setBackground();
        // 3. Render weather metrics
        (0, _metricsViewDefault.default).render(_model.state.weather);
        // 4. Render hourly forecast of current day
        (0, _hourlyViewDefault.default).render(_model.getHoulryDayWeather());
        // 5. load 7-days forecast
        await _model.loadDailyForecast(units.temperature);
        // 6. Render 7-days forecast
        (0, _dailyViewDefault.default).render(_model.state.weather.daily);
    } catch (error) {
        (0, _errorViewDefault.default).render(error);
    }
};
const controlHourlyDay = function(checkedDay) {
    ...
    const data = _model.getHoulryDayWeather(checkedDay);
    // 2. Render hourly forecast
    (0, _hourlyViewDefault.default).render(data);
};
const controlUnitSetting = async function(unit, value) {
    try {
        ...
        if (unit === 'precipitation') {
            ...
            await _model.loadPrecipitaion(units.precipitation);
            (0, _metricsViewDefault.default).renderPrecipitation(_model.getPreciptation());
        }
        if (unit === 'wind-speed') {
            units.windSpeed = value;
            await _model.loadWindSpeed(units.windSpeed);
            (0, _metricsViewDefault.default).renderWind(_model.getWindSpeed());
        }
    } catch (error) {
        (0, _errorViewDefault.default).render(error);
    }
...
const controlUpdateBookmarks = function(bookmarkedCity) {
    ...
    _model.updateBookmark(bookmarkedCity);
    // 2. update view of city
    (0, _cityViewDefault.default).update(_model.state);
...
const controlBookmarks = async function(bookmarkedCity) {
    try {
        ...
        if (city === _model.state.city.name && country === _model.state.city.country) return;
...
},{}],"8PvEd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadCity", ()=>loadCity);
parcelHelpers.export(exports, "loadForecast", ()=>loadForecast);
parcelHelpers.export(exports, "loadDailyForecast", ()=>loadDailyForecast);
parcelHelpers.export(exports, "getHoulryDayWeather", ()=>getHoulryDayWeather);
parcelHelpers.export(exports, "loadPrecipitaion", ()=>loadPrecipitaion);
parcelHelpers.export(exports, "getPreciptation", ()=>getPreciptation);
parcelHelpers.export(exports, "loadWindSpeed", ()=>loadWindSpeed);
parcelHelpers.export(exports, "getWindSpeed", ()=>getWindSpeed);
parcelHelpers.export(exports, "loadUserLocation", ()=>loadUserLocation);
...
const loadCity = async function(cityName) {
    try {
        const { results } = await (0, _helper.getJSON)(`${(0, _config.COUNTRY_API)}${cityName}`);
        state.city = {
            name: results[0].name,
 ...
 */ const setHourlyForecast = function(data) {
    const { time, temperature_2m: temps, weather_code: weatherCode } = data.hourly;
...
const loadForecast = async function({ temperature, precipitation, windSpeed }) {
    try {
        const data = await (0, _helper.getJSON)(`${(0, _config.WEATHER_API)}latitude=${state.city.latitude}&longitude=${state.city.longitude}${(0, _config.WAETHER_API_METRICS)}&temperature_unit=${temperature}&wind_speed_unit=${windSpeed}&precipitation_unit=${precipitation}`);
...
const loadDailyForecast = async function(unit = "celsius") {
    try {
        const { daily: { temperature_2m_max: maxTemp, temperature_2m_min: minTemp, time, weather_code: weatherCode } } = await (0, _helper.getJSON)(`${(0, _config.WEATHER_API)}latitude=${state.city.latitude}&longitude=${state.city.longitude}${(0, _config.WAETHER_API_DAILY)}&temperature_unit=${unit}`);
...
const getHoulryDayWeather = function(day = state.weather.currentDay) {
    return state.weather.hourly.filter((hour)=>hour.day.toLowerCase() === day.toLowerCase());
};
const loadPrecipitaion = async function(unit) {
    try {
        const data = await (0, _helper.getJSON)(`${(0, _config.WEATHER_API)}latitude=${state.city.latitude}&longitude=${state.city.longitude}&current=precipitation&precipitation_unit=${unit}`);
        state.weather.metrics = state.weather.metrics.map((metric)=>metric["precipitation"] ? {
                precipitation: data.current.precipitation
            } : metric);
        state.weather.units = state.weather.units.map((unit)=>unit["precipitation"] ? {
...
const getPreciptation = function() {
    return {
        value: state.weather.metrics.at(-1).precipitation,
        unit: state.weather.units[3].precipitation
    };
};
const loadWindSpeed = async function(unit) {
    try {
        const data = await (0, _helper.getJSON)(`${(0, _config.WEATHER_API)}latitude=${state.city.latitude}&longitude=${state.city.longitude}&current=wind_speed_10m&wind_speed_unit=${unit}`);
        state.weather.metrics = state.weather.metrics.map((metric)=>metric["wind"] ? {
                wind: data.current.wind_speed_10m
            } : metric);
        state.weather.units = state.weather.units.map((unit)=>unit["wind"] ? {
...
const loadUserLocation = async function() {
    try {
        const location = await (0, _helper.getPosition)();
        state.city.latitude = location.coords.latitude;
        state.city.longitude = location.coords.longitude;
        const country = await (0, _helper.getJSON)(`${(0, _config.POSITION_API)}latitude=${state.city.latitude}&longitude=${state.city.longitude}`);
...
const updateBookmark = function(bookmarkedCity) {
 ...
 */ const removeBookmark = function(bookmarkedCity) {
    const bookmarkIndex = state.bookmarks.findIndex((bookmark)=>bookmark.name === bookmarkedCity.name && bookmark.country === bookmarkedCity.country);
 ...
 */ const checkBookmark = function(city) {
    const isBookmarked = state.bookmarks.some((bookmark)=>bookmark.name === city.name && bookmark.country === city.country);
    if (isBookmarked) return true;
    return false;
};
getStorage();

},{"./config":"8oaOz","../helper":"izU09","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8oaOz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "COUNTRY_API", ()=>COUNTRY_API);
parcelHelpers.export(exports, "POSITION_API", ()=>POSITION_API);
parcelHelpers.export(exports, "WEATHER_API", ()=>WEATHER_API);
parcelHelpers.export(exports, "WAETHER_API_METRICS", ()=>WAETHER_API_METRICS);
parcelHelpers.export(exports, "WAETHER_API_DAILY", ()=>WAETHER_API_DAILY);
parcelHelpers.export(exports, "WEATHER_CODE", ()=>WEATHER_CODE);
const COUNTRY_API = "https://geocoding-api.open-meteo.com/v1/search?name=";
const POSITION_API = `https://api.bigdatacloud.net/data/reverse-geocode-client?`;
const WEATHER_API = `https://api.open-meteo.com/v1/forecast?`;
const WAETHER_API_METRICS = `&hourly=temperature_2m,weather_code&current=temperature_2m,relative_humidity_2m,precipitation,wind_speed_10m,apparent_temperature,is_day`;
const WAETHER_API_DAILY = `&daily=weather_code,temperature_2m_max,temperature_2m_min&forecast_days=7`;
...
},{}],"izU09":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const getJSON = async function(url) {
    try {
        ...
        if (!response.ok) throw new Error(`Invalid Request(${response.statusText})`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"j8nvu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchbarView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aIQYh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _symbolDefsSvg = require("url:../../img/symbol-defs.svg");
var _symbolDefsSvgDefault = parcelHelpers.interopDefault(_symbolDefsSvg);
var _view = require("./view");
class CityView extends (0, _view.View) {
    ...
    _generateMarkup() {
        ...
        <div class="country-forecast__country">${this._data.city.name}, ${this._data.city.country}</div>
        <div class="country-forecast__date">${new Intl.DateTimeFormat(navigator.language, {
            weekday: "long",
            year: "numeric",
            month: "short",
            day: "numeric"
      ...
      <div class="country-forecast__temperature">${this._data.weather.currentTemp.temperature}&deg;</div>

      <button class ="bookmarks__btn" >
        <svg class="bookmarks__icon ">
          <use xlink:href="${0, _symbolDefsSvgDefault.default}#icon-heart${this._data.city.bookmarked ? ' ' : '-outlined'}"></use>
        </svg>
      </button>
    `;
    }
...
exports.default = new CityView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/symbol-defs.svg":"ltFap","./view":"85NCB"}],"ltFap":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("symbol-defs.3e99ff4b.svg") + "?" + Date.now();

},{}],"85NCB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    ...
    _addHandlerBtnDropdown() {
        this._btnDropdown.addEventListener("click", this._dropdownHandler.bind(this));
    }
    _dropdownHandler() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kNSqj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
class MetricsView extends (0, _view.View) {
    ...
    render(data) {
        this._data = data;
        const metricesValue = Array.from(document.querySelectorAll(".forecast-metrics__value"));
        metricesValue.forEach((metric, i)=>{
            metric.textContent = `${Object.values(this._data.metrics[i]).lastItem} ${Object.values(this._data.units[i]).lastItem}`;
        });
    }
...
exports.default = new MetricsView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./view":"85NCB"}],"h3iYw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _symbolDefsSvg = require("url:../../img/symbol-defs.svg");
var _symbolDefsSvgDefault = parcelHelpers.interopDefault(_symbolDefsSvg);
var _config = require("../config");
var _view = require("./view");
class DailyView extends (0, _view.View) {
    ...
    _generateDayBox(day) {
      ...
      <div class="daily-forecast-box">
        <div class="daily-forecast__weekday">${new Intl.DateTimeFormat(navigator.language, {
            weekday: "short"
        }).format(new Date(day.time))}</div>
          <svg class="daily-forecast__icon">
          <use xlink:href="${0, _symbolDefsSvgDefault.default}#${(0, _config.WEATHER_CODE).get(day.code)}"></use>
        </svg>  
...
exports.default = new DailyView();

},{"url:../../img/symbol-defs.svg":"ltFap","../config":"8oaOz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./view":"85NCB"}],"1sPNQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _symbolDefsSvg = require("url:../../img/symbol-defs.svg");
var _symbolDefsSvgDefault = parcelHelpers.interopDefault(_symbolDefsSvg);
var _config = require("../config");
var _view = require("./view");
class HourlyView extends (0, _view.View) {
    ...
    _clear() {
        const hourlyBox = Array.from(document.querySelectorAll(".hourly-forecast-box"));
    ...
    _generateHourlyBox(hour) {
      ...
      <div class="hourly-forecast-box">
         <svg class="hourly-forecast__icon">
          <use xlink:href="${0, _symbolDefsSvgDefault.default}#${(0, _config.WEATHER_CODE).get(hour.weatherCode)}"></use>
        </svg>
        <p class="hourly-forecast__hour">${new Intl.DateTimeFormat(navigator.language, {
            hour: "2-digit"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/symbol-defs.svg":"ltFap","../config":"8oaOz","./view":"85NCB"}],"2f1aQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
class SettingView extends (0, _view.View) {
    ...
    addHandlerInputUnits(handler) {
        this._inputUnits.forEach((input)=>{
            input.addEventListener('click', (e)=>{
                ...
                siblings.forEach((sibling)=>sibling.classList.contains('dropdown__list--item') && sibling.classList.remove('selected'));
                this._dropdownHandler();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./view":"85NCB"}],"abnhn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
class ErrorView extends (0, _view.View) {
    ...
    render(error) {
        ...
        this._errorText.textContent = `${error} \u{26D4}`;
    }
    _addHandlerCloseBtn() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./view":"85NCB"}],"19jNB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _symbolDefsSvg = require("url:../../img/symbol-defs.svg");
var _symbolDefsSvgDefault = parcelHelpers.interopDefault(_symbolDefsSvg);
    ...
    _generateMarkup() {
        return `${this._data.map((bookmark)=>{
            return ` <li class="dropdown__item" data-name="${bookmark.name}" data-country ="${bookmark.country}">
                <svg class="bookmarks__icon">
                  <use xlink:href="${0, _symbolDefsSvgDefault.default}#icon-location-pin"></use>
                </svg>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/symbol-defs.svg":"ltFap","./view":"85NCB"}]},["8UOts","lCMa2"], "lCMa2", "parcelRequirebbde", {}, "./", "/")

//# sourceMappingURL=Weather-App.c91491ac.js.map
